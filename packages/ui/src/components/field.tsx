import { Label } from '@auto-deck/ui/components/label';
import { Separator } from '@auto-deck/ui/components/separator';
...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: a div avoids the browser-specific flex layout quirks of fieldset; FieldSet provides the semantic element.
    <div
      role="group"
      data-slot="field"
